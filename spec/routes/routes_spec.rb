...
RSpec.describe "Routing", type: :routing do
  ...
  describe "Subscriptions Routes" do
    ...
    it "routes to subscription create" do
      expect(post: "/subscriptions/stripe_product_id").to route_to(controller: "subscriptions", action: "create", stripe_product_id: "stripe_product_id")
    end

    it "routes to destroy subscription" do
      expect(delete: "/subscriptions/stripe_subscription_id").to route_to(controller: "subscriptions", action: "destroy", stripe_subscription_id: "stripe_subscription_id")
    end
  end
